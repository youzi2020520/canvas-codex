...
1. Identify the exact claim and the fields, units, time range, and comparison basis.
...
- Never invent missing data. Use a clearly labeled placeholder when the brief has no values.
