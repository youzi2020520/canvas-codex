...
```json
{"id":"chart-1","type":"chart","x":120,"y":160,"width":700,"height":320,"text":"Accessible conclusion","src":"","chart":{"type":"bar","title":"","unit":"%","categories":["A","B"],"series":[{"name":"Value","data":[42,61]}],"colors":["#14b8a6"],"accessibilitySummary":"B is higher than A"},"style":{},"layout":{"mode":"free"}}
```
